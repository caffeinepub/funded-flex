...
import { Heart, Mail, MapPin, Phone, Pizza } from "lucide-react";
import { SiWhatsapp } from "react-icons/si";

export default function Footer() {
  const year = new Date().getFullYear();
  const hostname =
    typeof window !== "undefined" ? window.location.hostname : "samaypizza";
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <div>
                ...
                <p className="text-xs" style={{ color: "#FFCDD2" }}>
                  Fresh &amp; Delicious
                </p>
              </div>
            </div>
            <p className="text-sm leading-relaxed" style={{ color: "#FFCDD2" }}>
              Serving the best pizza, Chinese, burgers and more in Gorakhpur.
              Made fresh with love, delivered hot to your door.
            </p>
          </div>
