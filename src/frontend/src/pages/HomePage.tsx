    ...
    <div className="min-h-screen" style={{ backgroundColor: "#FAFAFA" }}>
      ...
      <section className="relative min-h-[85vh] flex items-center overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "url('/assets/generated/hero-banner.dim_1200x500.png')",
          }}
        />
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 py-20 w-full">
          <div className="max-w-2xl">
            ...
            >
              ...
              <span>Pipiganj's Favourite Pizza Place</span>
            </div>
            ...
            <p
              className="text-lg sm:text-xl mb-8 leading-relaxed animate-fade-up-delay-2"
              style={{ color: "#FFCDD2" }}
            >
              Fresh, hot &amp; delicious pizza delivered to your door. Serving
              Gorakhpur with love since day one.
            </p>
        ...
        <div className="absolute bottom-8 left-1/2 -translate-x-1/2 animate-bounce-slow">
          <div
            className="w-6 h-10 border-2 rounded-full flex items-start justify-center pt-1.5"
      ...
      <section className="py-14 bg-white">
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {features.map((f) => (
              <div key={f.title} className="pizza-card p-5 text-center group">
                <div
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-500 text-base max-w-md mx-auto">
              From crispy pizzas to sizzling Chinese — we've got everything to
      ...
      <section className="py-14 red-gradient-bg">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 text-center">
          ...
          <p className="text-lg mb-8" style={{ color: "#FFCDD2" }}>
            Call us or WhatsApp your order. We deliver hot &amp; fresh to your
            doorstep in Gorakhpur.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a
              href="tel:+918753671877"
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-6 text-center sm:text-left">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-500 text-sm">
                  Sonauli Road Pipiganj, Gorakhpur
                </p>
              </div>
            </div>
          </div>
